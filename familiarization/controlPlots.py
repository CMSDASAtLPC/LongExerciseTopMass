...
# Open the file
fiData = TFile.Open("/uscms_data/d3/ebouvier/CMS_DAS_FNAL/Data13TeV_MuonEG_2015D_v4.root", "READ")
# Get the tree
...
# Open the file
fiMC = TFile.Open("/uscms_data/d3/ebouvier/CMS_DAS_FNAL/MC13TeV_TTJets.root", "READ")
# Get the tree
