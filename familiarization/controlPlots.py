...
# Open the file
fiData = TFile.Open(" root://cmseos.fnal.gov///store/user/cmsdas/2018/long_exercises/TopMass/MuonEG_2016Hv2.root", "READ")
# Get the tree
...
# Open the file
fiMC = TFile.Open(" root://cmseos.fnal.gov///store/user/cmsdas/2018/long_exercises/TopMass/TTJets.root", "READ")
# Get the tree
