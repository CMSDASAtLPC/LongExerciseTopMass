...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-72.28916,-4768.346,530.1205,34968.71);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__15->SetMaximum(34571.34);
   frame__15->SetEntries(61714);
   ...
   bjeten_t#bar{t}_stack_1->SetBinContent(2,969.2556);
   bjeten_t#bar{t}_stack_1->SetBinContent(3,18280.12);
   bjeten_t#bar{t}_stack_1->SetBinContent(4,25184.81);
   bjeten_t#bar{t}_stack_1->SetBinContent(5,25492.63);
   bjeten_t#bar{t}_stack_1->SetBinContent(6,22631.73);
   bjeten_t#bar{t}_stack_1->SetBinContent(7,19030.1);
   bjeten_t#bar{t}_stack_1->SetBinContent(8,15581.4);
   bjeten_t#bar{t}_stack_1->SetBinContent(9,12613.56);
   bjeten_t#bar{t}_stack_1->SetBinContent(10,10178.37);
   bjeten_t#bar{t}_stack_1->SetBinContent(11,8095.369);
   bjeten_t#bar{t}_stack_1->SetBinContent(12,6758.145);
   bjeten_t#bar{t}_stack_1->SetBinContent(13,5599.453);
   bjeten_t#bar{t}_stack_1->SetBinContent(14,4386.379);
   bjeten_t#bar{t}_stack_1->SetBinContent(15,3697.76);
   bjeten_t#bar{t}_stack_1->SetBinContent(16,2966.726);
   bjeten_t#bar{t}_stack_1->SetBinContent(17,2513.77);
   bjeten_t#bar{t}_stack_1->SetBinContent(18,2231.673);
   bjeten_t#bar{t}_stack_1->SetBinContent(19,1710.825);
   bjeten_t#bar{t}_stack_1->SetBinContent(20,1488.435);
   bjeten_t#bar{t}_stack_1->SetBinContent(21,1272.734);
   bjeten_t#bar{t}_stack_1->SetBinContent(22,1010.904);
   bjeten_t#bar{t}_stack_1->SetBinContent(23,922.9571);
   bjeten_t#bar{t}_stack_1->SetBinContent(24,781.7019);
   bjeten_t#bar{t}_stack_1->SetBinContent(25,703.5029);
   bjeten_t#bar{t}_stack_1->SetBinContent(26,544.5271);
   bjeten_t#bar{t}_stack_1->SetBinContent(27,399.298);
   bjeten_t#bar{t}_stack_1->SetBinContent(28,350.0528);
   bjeten_t#bar{t}_stack_1->SetBinContent(29,353.6304);
   bjeten_t#bar{t}_stack_1->SetBinContent(30,289.6597);
   bjeten_t#bar{t}_stack_1->SetBinContent(31,2228.242);
   bjeten_t#bar{t}_stack_1->SetBinError(2,61.19197);
   bjeten_t#bar{t}_stack_1->SetBinError(3,265.8656);
   bjeten_t#bar{t}_stack_1->SetBinError(4,312.3699);
   bjeten_t#bar{t}_stack_1->SetBinError(5,313.6325);
   bjeten_t#bar{t}_stack_1->SetBinError(6,295.7978);
   bjeten_t#bar{t}_stack_1->SetBinError(7,271.416);
   bjeten_t#bar{t}_stack_1->SetBinError(8,245.367);
   bjeten_t#bar{t}_stack_1->SetBinError(9,220.9642);
   bjeten_t#bar{t}_stack_1->SetBinError(10,198.4268);
   bjeten_t#bar{t}_stack_1->SetBinError(11,176.9567);
   bjeten_t#bar{t}_stack_1->SetBinError(12,161.3965);
   bjeten_t#bar{t}_stack_1->SetBinError(13,146.8984);
   bjeten_t#bar{t}_stack_1->SetBinError(14,130.0311);
   bjeten_t#bar{t}_stack_1->SetBinError(15,119.8846);
   bjeten_t#bar{t}_stack_1->SetBinError(16,107.7333);
   bjeten_t#bar{t}_stack_1->SetBinError(17,98.26712);
   bjeten_t#bar{t}_stack_1->SetBinError(18,93.17617);
   bjeten_t#bar{t}_stack_1->SetBinError(19,81.45883);
   bjeten_t#bar{t}_stack_1->SetBinError(20,76.0406);
   bjeten_t#bar{t}_stack_1->SetBinError(21,70.34869);
   bjeten_t#bar{t}_stack_1->SetBinError(22,62.34099);
   bjeten_t#bar{t}_stack_1->SetBinError(23,59.55001);
   bjeten_t#bar{t}_stack_1->SetBinError(24,55.00404);
   bjeten_t#bar{t}_stack_1->SetBinError(25,52.32837);
   bjeten_t#bar{t}_stack_1->SetBinError(26,45.68844);
   bjeten_t#bar{t}_stack_1->SetBinError(27,39.21409);
   bjeten_t#bar{t}_stack_1->SetBinError(28,36.15801);
   bjeten_t#bar{t}_stack_1->SetBinError(29,37.30829);
   bjeten_t#bar{t}_stack_1->SetBinError(30,33.59171);
   bjeten_t#bar{t}_stack_1->SetBinError(31,93.05008);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__16->SetEntries(61714);
   ...
   Graph_Graph_from_ratio3016->SetMaximum(1.184124);
