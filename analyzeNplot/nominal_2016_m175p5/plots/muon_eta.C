...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-3.609639,-1677.661,3.137349,12303.68);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__5->SetMaximum(12163.87);
   frame__5->SetEntries(45339);
   ...
   mc_stack_3->SetMaximum(9824.663);
   ...
   muon_eta_t#bar{t}_stack_1->SetBinContent(3,1333.079);
   muon_eta_t#bar{t}_stack_1->SetBinContent(4,1862.082);
   muon_eta_t#bar{t}_stack_1->SetBinContent(5,2810.209);
   muon_eta_t#bar{t}_stack_1->SetBinContent(6,3044.93);
   muon_eta_t#bar{t}_stack_1->SetBinContent(7,4203.312);
   muon_eta_t#bar{t}_stack_1->SetBinContent(8,4808.545);
   muon_eta_t#bar{t}_stack_1->SetBinContent(9,5573.204);
   muon_eta_t#bar{t}_stack_1->SetBinContent(10,6917.709);
   muon_eta_t#bar{t}_stack_1->SetBinContent(11,7148.375);
   muon_eta_t#bar{t}_stack_1->SetBinContent(12,8187.566);
   muon_eta_t#bar{t}_stack_1->SetBinContent(13,8680.323);
   muon_eta_t#bar{t}_stack_1->SetBinContent(14,8053.244);
   muon_eta_t#bar{t}_stack_1->SetBinContent(15,8779.822);
   muon_eta_t#bar{t}_stack_1->SetBinContent(16,8922.437);
   muon_eta_t#bar{t}_stack_1->SetBinContent(17,7568.426);
   muon_eta_t#bar{t}_stack_1->SetBinContent(18,8624.844);
   muon_eta_t#bar{t}_stack_1->SetBinContent(19,8064.633);
   muon_eta_t#bar{t}_stack_1->SetBinContent(20,6771.9);
   muon_eta_t#bar{t}_stack_1->SetBinContent(21,7060.948);
   muon_eta_t#bar{t}_stack_1->SetBinContent(22,6031.882);
   muon_eta_t#bar{t}_stack_1->SetBinContent(23,5087.487);
   muon_eta_t#bar{t}_stack_1->SetBinContent(24,4034.592);
   muon_eta_t#bar{t}_stack_1->SetBinContent(25,3384.209);
   muon_eta_t#bar{t}_stack_1->SetBinContent(26,3003.973);
   muon_eta_t#bar{t}_stack_1->SetBinContent(27,1947.238);
   muon_eta_t#bar{t}_stack_1->SetBinContent(28,1368.37);
   muon_eta_t#bar{t}_stack_1->SetBinError(3,71.11362);
   muon_eta_t#bar{t}_stack_1->SetBinError(4,83.72775);
   muon_eta_t#bar{t}_stack_1->SetBinError(5,104.4019);
   muon_eta_t#bar{t}_stack_1->SetBinError(6,108.3596);
   muon_eta_t#bar{t}_stack_1->SetBinError(7,127.828);
   muon_eta_t#bar{t}_stack_1->SetBinError(8,136.6567);
   muon_eta_t#bar{t}_stack_1->SetBinError(9,146.4945);
   muon_eta_t#bar{t}_stack_1->SetBinError(10,162.9377);
   muon_eta_t#bar{t}_stack_1->SetBinError(11,166.0695);
   muon_eta_t#bar{t}_stack_1->SetBinError(12,178.1347);
   muon_eta_t#bar{t}_stack_1->SetBinError(13,183.3427);
   muon_eta_t#bar{t}_stack_1->SetBinError(14,176.9652);
   muon_eta_t#bar{t}_stack_1->SetBinError(15,184.5637);
   muon_eta_t#bar{t}_stack_1->SetBinError(16,186.2088);
   muon_eta_t#bar{t}_stack_1->SetBinError(17,171.6886);
   muon_eta_t#bar{t}_stack_1->SetBinError(18,183.0503);
   muon_eta_t#bar{t}_stack_1->SetBinError(19,177.1818);
   muon_eta_t#bar{t}_stack_1->SetBinError(20,161.6078);
   muon_eta_t#bar{t}_stack_1->SetBinError(21,164.4819);
   muon_eta_t#bar{t}_stack_1->SetBinError(22,152.1266);
   muon_eta_t#bar{t}_stack_1->SetBinError(23,140.4086);
   muon_eta_t#bar{t}_stack_1->SetBinError(24,125.3235);
   muon_eta_t#bar{t}_stack_1->SetBinError(25,114.6864);
   muon_eta_t#bar{t}_stack_1->SetBinError(26,107.6098);
   muon_eta_t#bar{t}_stack_1->SetBinError(27,85.59782);
   muon_eta_t#bar{t}_stack_1->SetBinError(28,71.80484);
   muon_eta_t#bar{t}_stack_1->SetEntries(39651);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__6->SetEntries(45339);
   ...
   Graph_Graph_from_ratio3006->SetMaximum(1.080114);
