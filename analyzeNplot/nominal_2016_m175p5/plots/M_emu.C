...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-72.28916,-3226.688,530.1205,23663.21);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   mc_stack_6->SetMaximum(18895.41);
   ...
   M_emu_t#bar{t}_stack_1->SetBinContent(1,805.3358);
   M_emu_t#bar{t}_stack_1->SetBinContent(2,6718.767);
   M_emu_t#bar{t}_stack_1->SetBinContent(3,10654.13);
   M_emu_t#bar{t}_stack_1->SetBinContent(4,14866.93);
   M_emu_t#bar{t}_stack_1->SetBinContent(5,17353.28);
   M_emu_t#bar{t}_stack_1->SetBinContent(6,16848.69);
   M_emu_t#bar{t}_stack_1->SetBinContent(7,14820);
   M_emu_t#bar{t}_stack_1->SetBinContent(8,12188.68);
   M_emu_t#bar{t}_stack_1->SetBinContent(9,10092.89);
   M_emu_t#bar{t}_stack_1->SetBinContent(10,7939.223);
   M_emu_t#bar{t}_stack_1->SetBinContent(11,6588.732);
   M_emu_t#bar{t}_stack_1->SetBinContent(12,5001.485);
   M_emu_t#bar{t}_stack_1->SetBinContent(13,4243.912);
   M_emu_t#bar{t}_stack_1->SetBinContent(14,3107.339);
   M_emu_t#bar{t}_stack_1->SetBinContent(15,2518.321);
   M_emu_t#bar{t}_stack_1->SetBinContent(16,1923.229);
   M_emu_t#bar{t}_stack_1->SetBinContent(17,1580.529);
   M_emu_t#bar{t}_stack_1->SetBinContent(18,1135.087);
   M_emu_t#bar{t}_stack_1->SetBinContent(19,959.4662);
   M_emu_t#bar{t}_stack_1->SetBinContent(20,782.1658);
   M_emu_t#bar{t}_stack_1->SetBinContent(21,553.0986);
   M_emu_t#bar{t}_stack_1->SetBinContent(22,385.4836);
   M_emu_t#bar{t}_stack_1->SetBinContent(23,420.0548);
   M_emu_t#bar{t}_stack_1->SetBinContent(24,325.7607);
   M_emu_t#bar{t}_stack_1->SetBinContent(25,227.6089);
   M_emu_t#bar{t}_stack_1->SetBinContent(26,168.4885);
   M_emu_t#bar{t}_stack_1->SetBinContent(27,183.9183);
   M_emu_t#bar{t}_stack_1->SetBinContent(28,153.5313);
   M_emu_t#bar{t}_stack_1->SetBinContent(29,132.5099);
   M_emu_t#bar{t}_stack_1->SetBinContent(30,89.90274);
   M_emu_t#bar{t}_stack_1->SetBinContent(31,504.7917);
   M_emu_t#bar{t}_stack_1->SetBinError(1,55.50454);
   M_emu_t#bar{t}_stack_1->SetBinError(2,160.5125);
   M_emu_t#bar{t}_stack_1->SetBinError(3,202.1406);
   M_emu_t#bar{t}_stack_1->SetBinError(4,238.3512);
   M_emu_t#bar{t}_stack_1->SetBinError(5,258.1549);
   M_emu_t#bar{t}_stack_1->SetBinError(6,254.7773);
   M_emu_t#bar{t}_stack_1->SetBinError(7,239.4513);
   M_emu_t#bar{t}_stack_1->SetBinError(8,217.0289);
   M_emu_t#bar{t}_stack_1->SetBinError(9,198.0638);
   M_emu_t#bar{t}_stack_1->SetBinError(10,175.6765);
   M_emu_t#bar{t}_stack_1->SetBinError(11,160.1872);
   M_emu_t#bar{t}_stack_1->SetBinError(12,140.1873);
   M_emu_t#bar{t}_stack_1->SetBinError(13,128.871);
   M_emu_t#bar{t}_stack_1->SetBinError(14,110.1801);
   M_emu_t#bar{t}_stack_1->SetBinError(15,99.22037);
   M_emu_t#bar{t}_stack_1->SetBinError(16,87.15485);
   M_emu_t#bar{t}_stack_1->SetBinError(17,78.75512);
   M_emu_t#bar{t}_stack_1->SetBinError(18,66.75145);
   M_emu_t#bar{t}_stack_1->SetBinError(19,61.61843);
   M_emu_t#bar{t}_stack_1->SetBinError(20,54.88458);
   M_emu_t#bar{t}_stack_1->SetBinError(21,46.48716);
   M_emu_t#bar{t}_stack_1->SetBinError(22,39.12104);
   M_emu_t#bar{t}_stack_1->SetBinError(23,41.04517);
   M_emu_t#bar{t}_stack_1->SetBinError(24,36.00176);
   M_emu_t#bar{t}_stack_1->SetBinError(25,29.88465);
   M_emu_t#bar{t}_stack_1->SetBinError(26,26.01733);
   M_emu_t#bar{t}_stack_1->SetBinError(27,27.20032);
   M_emu_t#bar{t}_stack_1->SetBinError(28,24.79545);
   M_emu_t#bar{t}_stack_1->SetBinError(29,23.01068);
   M_emu_t#bar{t}_stack_1->SetBinError(30,18.90612);
   M_emu_t#bar{t}_stack_1->SetBinError(31,44.57438);
   M_emu_t#bar{t}_stack_1->SetEntries(39651);
...
// ------------>Primitives in pad: p2
   ...
   Graph_Graph_from_ratio3012->SetMinimum(0.5139359);
   Graph_Graph_from_ratio3012->SetMaximum(1.334192);
