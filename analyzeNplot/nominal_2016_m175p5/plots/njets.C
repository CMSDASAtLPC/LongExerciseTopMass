...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-1.445783,-14772.74,10.60241,108334.3);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   mc_stack_2->SetMaximum(86506.43);
   ...
   njets_t#bar{t}_stack_1->SetBinContent(3,77894.6);
   njets_t#bar{t}_stack_1->SetBinContent(4,41936.04);
   njets_t#bar{t}_stack_1->SetBinContent(5,16239.27);
   njets_t#bar{t}_stack_1->SetBinContent(6,5264.942);
   njets_t#bar{t}_stack_1->SetBinContent(7,1453.329);
   njets_t#bar{t}_stack_1->SetBinContent(8,374.7863);
   njets_t#bar{t}_stack_1->SetBinContent(9,90.62153);
   njets_t#bar{t}_stack_1->SetBinContent(10,20.07557);
   njets_t#bar{t}_stack_1->SetBinError(3,548.7088);
   njets_t#bar{t}_stack_1->SetBinError(4,402.7753);
   njets_t#bar{t}_stack_1->SetBinError(5,250.4951);
   njets_t#bar{t}_stack_1->SetBinError(6,143.0484);
   njets_t#bar{t}_stack_1->SetBinError(7,75.15785);
   njets_t#bar{t}_stack_1->SetBinError(8,38.03947);
   njets_t#bar{t}_stack_1->SetBinError(9,18.56396);
   njets_t#bar{t}_stack_1->SetBinError(10,8.989469);
   njets_t#bar{t}_stack_1->SetEntries(39651);
...
// ------------>Primitives in pad: p2
   ...
   Graph_Graph_from_ratio3004->SetMaximum(1.564858);
