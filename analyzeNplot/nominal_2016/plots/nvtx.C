...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-7.228916,-1664.091,53.01205,12204.17);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__23->SetMaximum(12065.49);
   frame__23->SetEntries(365945);
   ...
   mc_stack_12->SetMaximum(9745.201);
   ...
   nvtx_t#bar{t}_stack_1->SetBinContent(31,2231.021);
   nvtx_t#bar{t}_stack_1->SetBinContent(32,1780.446);
   nvtx_t#bar{t}_stack_1->SetBinContent(33,1404.175);
   nvtx_t#bar{t}_stack_1->SetBinContent(34,1110.572);
   nvtx_t#bar{t}_stack_1->SetBinContent(35,863.9863);
   nvtx_t#bar{t}_stack_1->SetBinContent(36,627.7006);
   nvtx_t#bar{t}_stack_1->SetBinContent(37,490.9953);
   nvtx_t#bar{t}_stack_1->SetBinContent(38,402.2416);
   nvtx_t#bar{t}_stack_1->SetBinContent(39,266.0336);
   nvtx_t#bar{t}_stack_1->SetBinContent(40,200.1754);
   nvtx_t#bar{t}_stack_1->SetBinContent(41,146.3134);
   nvtx_t#bar{t}_stack_1->SetBinContent(42,105.3854);
   nvtx_t#bar{t}_stack_1->SetBinContent(43,70.71236);
   nvtx_t#bar{t}_stack_1->SetBinContent(44,60.45083);
   nvtx_t#bar{t}_stack_1->SetBinContent(45,44.27293);
   nvtx_t#bar{t}_stack_1->SetBinContent(46,31.28657);
   nvtx_t#bar{t}_stack_1->SetBinContent(47,19.84552);
   nvtx_t#bar{t}_stack_1->SetBinContent(48,13.70861);
   nvtx_t#bar{t}_stack_1->SetBinContent(49,12.10629);
   nvtx_t#bar{t}_stack_1->SetBinContent(50,8.98436);
   nvtx_t#bar{t}_stack_1->SetBinContent(51,26.69074);
   ...
   nvtx_t#bar{t}_stack_1->SetBinError(31,30.25637);
   nvtx_t#bar{t}_stack_1->SetBinError(32,26.73853);
   nvtx_t#bar{t}_stack_1->SetBinError(33,23.32787);
   nvtx_t#bar{t}_stack_1->SetBinError(34,20.40331);
   nvtx_t#bar{t}_stack_1->SetBinError(35,17.83819);
   nvtx_t#bar{t}_stack_1->SetBinError(36,14.77329);
   nvtx_t#bar{t}_stack_1->SetBinError(37,12.83389);
   nvtx_t#bar{t}_stack_1->SetBinError(38,11.36984);
   nvtx_t#bar{t}_stack_1->SetBinError(39,9.112085);
   nvtx_t#bar{t}_stack_1->SetBinError(40,7.632594);
   nvtx_t#bar{t}_stack_1->SetBinError(41,6.226321);
   nvtx_t#bar{t}_stack_1->SetBinError(42,5.232409);
   nvtx_t#bar{t}_stack_1->SetBinError(43,4.080526);
   nvtx_t#bar{t}_stack_1->SetBinError(44,3.764571);
   nvtx_t#bar{t}_stack_1->SetBinError(45,3.209478);
   nvtx_t#bar{t}_stack_1->SetBinError(46,2.536416);
   nvtx_t#bar{t}_stack_1->SetBinError(47,1.954841);
   nvtx_t#bar{t}_stack_1->SetBinError(48,1.44101);
   nvtx_t#bar{t}_stack_1->SetBinError(49,1.394389);
   nvtx_t#bar{t}_stack_1->SetBinError(50,1.178196);
   nvtx_t#bar{t}_stack_1->SetBinError(51,1.786499);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__24->SetEntries(365945);
   ...
   Graph_Graph_from_ratio3024->SetMaximum(4.538451);
