...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-1.445783,-14370.18,10.60241,105382.1);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   mc_stack_2->SetMaximum(84149.12);
   ...
   njets_t#bar{t}_stack_1->SetBinContent(3,75649.54);
   njets_t#bar{t}_stack_1->SetBinContent(4,40415.26);
   njets_t#bar{t}_stack_1->SetBinContent(5,15259.34);
   njets_t#bar{t}_stack_1->SetBinContent(6,4894.009);
   njets_t#bar{t}_stack_1->SetBinContent(7,1384.703);
   njets_t#bar{t}_stack_1->SetBinContent(8,370.7455);
   njets_t#bar{t}_stack_1->SetBinContent(9,94.18178);
   njets_t#bar{t}_stack_1->SetBinContent(10,25.49452);
   njets_t#bar{t}_stack_1->SetBinContent(11,7.158522);
   njets_t#bar{t}_stack_1->SetBinError(3,176.1991);
   njets_t#bar{t}_stack_1->SetBinError(4,128.9073);
   njets_t#bar{t}_stack_1->SetBinError(5,79.25038);
   njets_t#bar{t}_stack_1->SetBinError(6,44.89483);
   njets_t#bar{t}_stack_1->SetBinError(7,23.90364);
   njets_t#bar{t}_stack_1->SetBinError(8,12.34992);
   njets_t#bar{t}_stack_1->SetBinError(9,6.234371);
   njets_t#bar{t}_stack_1->SetBinError(10,3.279183);
   njets_t#bar{t}_stack_1->SetBinError(11,1.708805);
   njets_t#bar{t}_stack_1->SetEntries(360257);
...
// ------------>Primitives in pad: p2
   ...
   Graph_Graph_from_ratio3004->SetMaximum(1.035397);
