...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-3.609639,-1630.115,3.137349,11955.01);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__5->SetMaximum(11819.16);
   frame__5->SetEntries(32767);
   ...
   mc_stack_3->SetMaximum(9546.241);
   ...
   muon_eta_t#bar{t}_stack_1->SetBinContent(3,1271.132);
   muon_eta_t#bar{t}_stack_1->SetBinContent(4,1807.061);
   muon_eta_t#bar{t}_stack_1->SetBinContent(5,2758.129);
   muon_eta_t#bar{t}_stack_1->SetBinContent(6,3030.206);
   muon_eta_t#bar{t}_stack_1->SetBinContent(7,3990.608);
   muon_eta_t#bar{t}_stack_1->SetBinContent(8,4656.518);
   muon_eta_t#bar{t}_stack_1->SetBinContent(9,5473.112);
   muon_eta_t#bar{t}_stack_1->SetBinContent(10,6135.887);
   muon_eta_t#bar{t}_stack_1->SetBinContent(11,6668.6);
   muon_eta_t#bar{t}_stack_1->SetBinContent(12,7410.588);
   muon_eta_t#bar{t}_stack_1->SetBinContent(13,7884.78);
   muon_eta_t#bar{t}_stack_1->SetBinContent(14,7385.137);
   muon_eta_t#bar{t}_stack_1->SetBinContent(15,8386.48);
   muon_eta_t#bar{t}_stack_1->SetBinContent(16,8657.272);
   muon_eta_t#bar{t}_stack_1->SetBinContent(17,7371.363);
   muon_eta_t#bar{t}_stack_1->SetBinContent(18,8144.302);
   muon_eta_t#bar{t}_stack_1->SetBinContent(19,7771.145);
   muon_eta_t#bar{t}_stack_1->SetBinContent(20,6776.596);
   muon_eta_t#bar{t}_stack_1->SetBinContent(21,6385.439);
   muon_eta_t#bar{t}_stack_1->SetBinContent(22,5423.288);
   muon_eta_t#bar{t}_stack_1->SetBinContent(23,4742.405);
   muon_eta_t#bar{t}_stack_1->SetBinContent(24,3929.924);
   muon_eta_t#bar{t}_stack_1->SetBinContent(25,3134.149);
   muon_eta_t#bar{t}_stack_1->SetBinContent(26,2846.211);
   muon_eta_t#bar{t}_stack_1->SetBinContent(27,1904.492);
   muon_eta_t#bar{t}_stack_1->SetBinContent(28,1376.742);
   muon_eta_t#bar{t}_stack_1->SetBinError(3,81.40887);
   muon_eta_t#bar{t}_stack_1->SetBinError(4,97.12287);
   muon_eta_t#bar{t}_stack_1->SetBinError(5,122.0043);
   muon_eta_t#bar{t}_stack_1->SetBinError(6,127.5446);
   muon_eta_t#bar{t}_stack_1->SetBinError(7,146.1435);
   muon_eta_t#bar{t}_stack_1->SetBinError(8,157.8264);
   muon_eta_t#bar{t}_stack_1->SetBinError(9,170.8733);
   muon_eta_t#bar{t}_stack_1->SetBinError(10,180.1797);
   muon_eta_t#bar{t}_stack_1->SetBinError(11,188.6905);
   muon_eta_t#bar{t}_stack_1->SetBinError(12,199.209);
   muon_eta_t#bar{t}_stack_1->SetBinError(13,205.5622);
   muon_eta_t#bar{t}_stack_1->SetBinError(14,198.8145);
   muon_eta_t#bar{t}_stack_1->SetBinError(15,211.3214);
   muon_eta_t#bar{t}_stack_1->SetBinError(16,215.2392);
   muon_eta_t#bar{t}_stack_1->SetBinError(17,198.4696);
   muon_eta_t#bar{t}_stack_1->SetBinError(18,209.0298);
   muon_eta_t#bar{t}_stack_1->SetBinError(19,204.3185);
   muon_eta_t#bar{t}_stack_1->SetBinError(20,190.5031);
   muon_eta_t#bar{t}_stack_1->SetBinError(21,184.1801);
   muon_eta_t#bar{t}_stack_1->SetBinError(22,170.5096);
   muon_eta_t#bar{t}_stack_1->SetBinError(23,158.6818);
   muon_eta_t#bar{t}_stack_1->SetBinError(24,144.779);
   muon_eta_t#bar{t}_stack_1->SetBinError(25,129.2993);
   muon_eta_t#bar{t}_stack_1->SetBinError(26,123.4502);
   muon_eta_t#bar{t}_stack_1->SetBinError(27,99.72855);
   muon_eta_t#bar{t}_stack_1->SetBinError(28,84.82568);
   muon_eta_t#bar{t}_stack_1->SetEntries(27079);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__6->SetEntries(32767);
   ...
   Graph_Graph_from_ratio3006->SetMaximum(1.112932);
