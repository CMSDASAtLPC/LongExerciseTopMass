...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-72.28916,-3076.458,530.1205,22561.53);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   mc_stack_6->SetMaximum(18015.69);
   ...
   M_emu_t#bar{t}_stack_1->SetBinContent(1,886.5119);
   M_emu_t#bar{t}_stack_1->SetBinContent(2,6292.919);
   M_emu_t#bar{t}_stack_1->SetBinContent(3,10220.49);
   M_emu_t#bar{t}_stack_1->SetBinContent(4,14209.55);
   M_emu_t#bar{t}_stack_1->SetBinContent(5,16515.46);
   M_emu_t#bar{t}_stack_1->SetBinContent(6,15922.81);
   M_emu_t#bar{t}_stack_1->SetBinContent(7,14514.12);
   M_emu_t#bar{t}_stack_1->SetBinContent(8,11770.75);
   M_emu_t#bar{t}_stack_1->SetBinContent(9,9652.719);
   M_emu_t#bar{t}_stack_1->SetBinContent(10,7563.563);
   M_emu_t#bar{t}_stack_1->SetBinContent(11,5801.044);
   M_emu_t#bar{t}_stack_1->SetBinContent(12,4541.319);
   M_emu_t#bar{t}_stack_1->SetBinContent(13,3609.764);
   M_emu_t#bar{t}_stack_1->SetBinContent(14,2799.604);
   M_emu_t#bar{t}_stack_1->SetBinContent(15,2335.196);
   M_emu_t#bar{t}_stack_1->SetBinContent(16,1660.327);
   M_emu_t#bar{t}_stack_1->SetBinContent(17,1493.713);
   M_emu_t#bar{t}_stack_1->SetBinContent(18,1038.19);
   M_emu_t#bar{t}_stack_1->SetBinContent(19,742.4522);
   M_emu_t#bar{t}_stack_1->SetBinContent(20,686.2024);
   M_emu_t#bar{t}_stack_1->SetBinContent(21,479.05);
   M_emu_t#bar{t}_stack_1->SetBinContent(22,429.9327);
   M_emu_t#bar{t}_stack_1->SetBinContent(23,339.6484);
   M_emu_t#bar{t}_stack_1->SetBinContent(24,309.7968);
   M_emu_t#bar{t}_stack_1->SetBinContent(25,261.1501);
   M_emu_t#bar{t}_stack_1->SetBinContent(26,196.1983);
   M_emu_t#bar{t}_stack_1->SetBinContent(27,125.2299);
   M_emu_t#bar{t}_stack_1->SetBinContent(28,179.1519);
   M_emu_t#bar{t}_stack_1->SetBinContent(29,94.35339);
   M_emu_t#bar{t}_stack_1->SetBinContent(30,92.79235);
   M_emu_t#bar{t}_stack_1->SetBinContent(31,557.5587);
   M_emu_t#bar{t}_stack_1->SetBinError(1,68.67674);
   M_emu_t#bar{t}_stack_1->SetBinError(2,182.3118);
   M_emu_t#bar{t}_stack_1->SetBinError(3,232.3993);
   M_emu_t#bar{t}_stack_1->SetBinError(4,274.2455);
   M_emu_t#bar{t}_stack_1->SetBinError(5,296.5095);
   M_emu_t#bar{t}_stack_1->SetBinError(6,290.6996);
   M_emu_t#bar{t}_stack_1->SetBinError(7,278.2377);
   M_emu_t#bar{t}_stack_1->SetBinError(8,251.3679);
   M_emu_t#bar{t}_stack_1->SetBinError(9,227.251);
   M_emu_t#bar{t}_stack_1->SetBinError(10,201.4315);
   M_emu_t#bar{t}_stack_1->SetBinError(11,176.445);
   M_emu_t#bar{t}_stack_1->SetBinError(12,156.4833);
   M_emu_t#bar{t}_stack_1->SetBinError(13,139.7108);
   M_emu_t#bar{t}_stack_1->SetBinError(14,122.9556);
   M_emu_t#bar{t}_stack_1->SetBinError(15,112.3427);
   M_emu_t#bar{t}_stack_1->SetBinError(16,94.76995);
   M_emu_t#bar{t}_stack_1->SetBinError(17,89.96459);
   M_emu_t#bar{t}_stack_1->SetBinError(18,75.41024);
   M_emu_t#bar{t}_stack_1->SetBinError(19,63.0404);
   M_emu_t#bar{t}_stack_1->SetBinError(20,61.83166);
   M_emu_t#bar{t}_stack_1->SetBinError(21,51.00945);
   M_emu_t#bar{t}_stack_1->SetBinError(22,48.28653);
   M_emu_t#bar{t}_stack_1->SetBinError(23,42.8185);
   M_emu_t#bar{t}_stack_1->SetBinError(24,41.28306);
   M_emu_t#bar{t}_stack_1->SetBinError(25,37.76972);
   M_emu_t#bar{t}_stack_1->SetBinError(26,32.97227);
   M_emu_t#bar{t}_stack_1->SetBinError(27,26.35347);
   M_emu_t#bar{t}_stack_1->SetBinError(28,31.48913);
   M_emu_t#bar{t}_stack_1->SetBinError(29,22.34018);
   M_emu_t#bar{t}_stack_1->SetBinError(30,21.68979);
   M_emu_t#bar{t}_stack_1->SetBinError(31,55.32014);
   M_emu_t#bar{t}_stack_1->SetEntries(27079);
...
// ------------>Primitives in pad: p2
   ...
   Graph_Graph_from_ratio3012->SetMinimum(0.4086752);
   Graph_Graph_from_ratio3012->SetMaximum(1.445594);
